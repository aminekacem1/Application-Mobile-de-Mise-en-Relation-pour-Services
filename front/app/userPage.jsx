...
// --- MODIFICATION DE L'ICÔNE CI-DESSOUS ---
const BottomNavBar = () => {
  const router = useRouter();
  return (
    <View style={styles.navBarContainer}>
      ...
      <TouchableOpacity style={styles.navBarButton} onPress={() => router.push('/serviceTracking')}>
        {/* L'icône du camion a été remplacée par "clipboard-check" */}
...
export default function TechnicianList() {
  ...
  const fetchTechnicians = async (query = '') => {
    setLoading(true);
    try {
      const res = await axios.get(`http://192.168.1.3:5000/api/technicians?q=${query}`);
      ...
      const mockData = [
        { _id: '1', name: 'Amine', profession: 'Plombier', rating: 4.8, distance: '2.6' },
        { _id: '2', name: 'Kacem', profession: 'Jardinier', rating: 4.6, distance: '4.7' },
      ];
